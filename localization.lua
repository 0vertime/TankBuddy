--
-- Localization file for TankBuddy v2.0
--
...
TB_GUI_EnableTankBuddy = "Enable TankBuddy";
TB_GUI_Raid = "Raid";
TB_GUI_Party = "Party";
TB_GUI_Alone = "Alone";
...
TB_defaultText_g = "Taunt resisted!";
TB_defaultText_t = "Taunt resisted!";
TB_defaultText_mb = "Mocking Blow resisted!";
TB_defaultText_ls = "Used Last Stand!";
TB_defaultText_sw = "Used Shield Wall!";
TB_defaultText_lg = "I'm bad and I used Lifegiving Gem because I had it equipped!";
TB_defaultText_cs = "Used Mass Taunt!";
TB_defaultText_cr = "Used Mass Taunt!";

TB_tauntLine = "Your Taunt was resisted by (.+)";
TB_growlLine = "Your Growl was resisted by (.+)";
...
TB_bs = "You gain Battle Shout.";
TB_cr = "Challenging Roar";
TB_gc = "Grip of Command";
TB_ds = "Divine Shield";
TB_rf = "Righteous Fury fades from you";
...
TB_salvation = "fSalvation";
TB_righteousfury = "SealOfFury";
TB_divineshield = "DivineIntervention";
TB_protection = "SealOfProtection";
TB_battleshout = "BattleShout";
...
TB_output_salvation = "Removed Salvation.";
TB_output_protection = "Removed BoP.";
TB_output_battleshout = "Removed Battle Shout.";
TB_output_intellect = "Removed Intellect.";
TB_output_spirit = "Removed Spirit.";
TB_output_divineshield = "Removed Divine Shield.";
TB_output_startup = " loaded. Type /TB for options.";
TB_output_alreadyOff = "TankBuddy is already disabled.";
TB_output_alreadyOn = "TankBuddy is already enabled.";
TB_output_off = "TankBuddy disabled.";
TB_output_on = "TankBuddy enabled.";
...
elseif (GetLocale() == "deDE") then -- German
	TB_GUI_EnableTankBuddy = "TankBuddy aktivieren";
	...
	TB_GUI_CS = "Challenging Shout"; --Need translation
	TB_GUI_Growl = "Growl"; --Need translation
	TB_GUI_CR = "Challenging Roar"; --Need translation
	TB_GUI_EnterNewText = {
		[TB_GUI_Taunt] = "Neuer Benachrichtigungstext wenn Spott wiederstanden wird:", --Need translation
		[TB_GUI_MB] = "Neuer Benachrichtigungstext wenn Sp\195\182ttischer Schlag verfehlt:", --Need translation
		[TB_GUI_LS] = "Enter new announcement text for using last stand:", --Need translation
		[TB_GUI_SW] = "Enter new announcement text for using shield wall:", --Need translation
		[TB_GUI_LG] = "Enter new announcement text for using lifegiving gem:", --Need translation
		[TB_GUI_CS] = "Enter new announcement text for using challenging shout:", --Need translation
		[TB_GUI_Growl] = "Enter new announcement text for resisted growls:", --Need translation
		[TB_GUI_CR] = "Enter new announcement text for using challenging roar:" --Need translation
	}
...
TB_GUI_HelpText = "Thank you for using TankBuddy!\n\nTo the right there are a number of tabs, depending on your class. Each tab has options for announcement message, and channels to announce to under given circumstances.\n\nHelp:\n\nThe leftmost column of checkboxes controls which channels to send the announcement message to, if you are in a raid. The middle column, if you are in a party, and the rightmost column, if you are alone.\nIf you check any of the \"Custom\"-boxes, a window will appear where you can type in the custom channel(s), either by channel name or number. To specify more than one channel, seperate with a space.\nWhen you have selected some channels, you can click the \"Copy\"-button to copy your selection, and then click another tab, and click the \"Paste\"-button to use the same selection there.\nNote! This will overwrite any custom channels you might have typed, with the ones from the copied source.\nYou can specify a message in the editbox at the bottom, and use the variables listed below:\n\nTaunt, Growl and Mocking Blow:\n$tn: Target Name (Same as %t)\n$tl: Target Level\n$tt: Target Type (Humanoid, Beast, Demon etc.)\n$ttn: Target's Target Name\n$ttl: Target's Target Level\n$ttt: Target's Target Type\nShield Wall, Challenging Shout, Challenging Roar, Last Stand and Lifegiving Gem:\n$sec: Duration of ability in seconds\n\nLast Stand and Lifegiving Gem:\n$hp: Amount of hitpoints gained by the ability.";
	...
	TB_defaultText_ls = "- I activated Last Stand! In $sec seconds I will lose $hpHP! -"; --Need translation
	TB_defaultText_sw = "- I activated Shield Wall and will be taking 75% less damage for $sec seconds! -"; --Need translation
	TB_defaultText_lg = "- I activated Lifegiving Gem! In $sec seconds I will lose $hpHP! -"; --Need translation
	TB_defaultText_cs = "- I activated Challenging Shout! I will need a lot of healing for $sec seconds! -"; --Need translation
	TB_defaultText_cr = "- I activated Challenging Roar! I will need a lot of healing for $sec seconds! -"; --Need translation
	...
	TB_cs = "Challenging Shout"; --Need translation, should be the name of the ability as the game perceives it!
	TB_cr = "Challenging Roar"; --Need translation, should be the name of the ability as the game perceives it!
	...
	TB_output_alreadyOff = "TankBuddy ist bereits deaktiviert.";
	TB_output_alreadyOn = "TankBuddy ist bereits aktiviert.";
	TB_output_off = "TankBuddy ist aktiv.";
	TB_output_on = "TankBuddy ist nicht aktiv.";
...
elseif (GetLocale() == "zhTW") then -- Chinese (traditional)
	...
	TB_defaultText_ls = "- 我開啟了破釜沉舟！在 $sec 秒後我會降低並損失 $hp HP！ -";
	TB_defaultText_sw = "- 我開啟了盾牆！在 $sec 秒內所有傷害值會降低 75%！ -";
	TB_defaultText_lg = "- 我開啟了生命寶石！在 $sec 秒後我會降低 $hp HP 最大值！ -";
	TB_defaultText_cs = "- I activated Challenging Shout! I will need a lot of healing for $sec seconds! -"; --Need translation
	TB_defaultText_cr = "- I activated Challenging Roar! I will need a lot of healing for $sec seconds! -"; --Need translation
